...
public record WarehouseItemQuantityOnHandUpdated(string ItemId, string WarehouseId, int Quantity) : DomainEvent;
...
public record WarehouseItemQuantityAvailableUpdated(string ItemId, string WarehouseId, int Quantity) : DomainEvent;