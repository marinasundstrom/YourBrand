...
public record ExperienceDto(string Id, string Title, string CompanyName, string? CompanyLogo, string? Link, string? Location, string EmploymentType, DateTime StartDate, DateTime? EndDate, bool Current, bool Highlight, string? Description, IEnumerable<ConsultantProfileSkillDto> Skills);
