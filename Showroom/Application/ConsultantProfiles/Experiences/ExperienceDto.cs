...
public record ExperienceDto(string Id, string?EmployerName, string Title, CompanyDto Company, string? Location, string EmploymentType, DateTime StartDate, DateTime? EndDate, bool Current, bool Highlight, string? Description, IEnumerable<ConsultantProfileSkillDto> Skills);
