...
namespace YourBrand.Warehouse.Infrastructure.BackgroundJobs;
...
public sealed class ProcessOutboxMessagesJob : IJob
{
    ...
    public ProcessOutboxMessagesJob(WarehouseContext dbContext, IDomainEventDispatcher domainEventDispatcher,
