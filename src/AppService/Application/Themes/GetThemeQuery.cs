...
public record ThemeDto(string Id, string Name, string? Description, string? Title, string? Logo, bool Dense, ThemeColorSchemesDto ColorSchemes, string? CustomCss);
