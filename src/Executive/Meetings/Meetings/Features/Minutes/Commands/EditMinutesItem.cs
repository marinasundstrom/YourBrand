...
public record EditMinutesItem(string OrganizationId, int Id, string ItemId, MinutesItemType Type, string Title, string Description, int? MotionId) : IRequest<Result<MinutesItemDto>>
{
