...
public record EditMinutesItem(string OrganizationId, int Id, string ItemId, int Type, string Title, string Description, int? MotionId) : IRequest<Result<MinutesItemDto>>
{
