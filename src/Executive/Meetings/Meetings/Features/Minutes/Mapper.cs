...
public static partial class Mappings
{
    ...
    public static MinutesItemDto ToDto(this MinutesItem item) => new(item.Id, item.Order, item.Type, item.AgendaId, item.AgendaItemId, item.Title!, item.State, item.Description, item.MotionId);
}