...
public sealed record AddMinutesItemDto(int? AgendaId, string? AgendaItemId, MinutesItemType Type, string Title, string Description, int? MotionId, int? Order);

public sealed record EditMinutesItemDto(MinutesItemType Type, string Title, string Description, int? MotionId);
