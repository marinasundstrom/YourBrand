...
public static partial class Mappings
{
    ...
    public static MeetingGroupMemberDto ToDto(this MeetingGroupMember member) => new(member.Id, member.Order, member.Name!, member.Role, member.Email, member.UserId, member.HasSpeakingRights, member.HasVotingRights);
}