...
{
    public static MeetingDto ToDto(this Meeting meeting) => new(meeting.Id, meeting.Title!, meeting.State, meeting.ScheduledAt, meeting.Location, meeting.Quorum.ToDto(), meeting.Participants.Select(x => x.ToDto()), meeting.CurrentAgendaItemIndex);
