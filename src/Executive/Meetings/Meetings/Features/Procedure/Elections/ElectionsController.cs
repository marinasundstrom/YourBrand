...
public sealed partial class ElectionsController(IMediator mediator) : ControllerBase
{
    ...
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ElectionDto))]
    [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(ProblemDetails))]
    [ProducesDefaultResponseType]
    public async Task<ActionResult<ElectionDto>> GetElection(string organizationId, int id, CancellationToken cancellationToken)
    {
