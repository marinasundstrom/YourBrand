...
public class Case : AuditableEntity<string>, IHasTenant, ISoftDeletableWithAudit<User>
{
    public Case()
...
public class Location : AuditableEntity<string>, ISoftDeletableWithAudit<User>
{
