...
public sealed record UpdateProductImage(string OrganizationId, string IdOrHandle, string ProductImageId, string? Title, string? Text) : IRequest<Result<ProductImageDto>>
{
