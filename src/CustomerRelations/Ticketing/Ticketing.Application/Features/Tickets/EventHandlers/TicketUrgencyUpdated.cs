...
public sealed class TicketUrgencyUpdatedEventHandler(IApplicationDbContext context, ITicketRepository ticketRepository, TicketPriorityCalculator ticketPriorityCalculator, IEmailService emailService, ITicketNotificationService ticketNotificationService, ISettableTenantContext tenantContext) : IDomainEventHandler<TicketUrgencyUpdated>
{
    public async Task Handle(TicketUrgencyUpdated notification, CancellationToken cancellationToken)
    {
