...
public sealed class TicketProjectUpdatedEventHandler(IApplicationDbContext context, ITicketRepository ticketRepository, IEmailService emailService, ITicketNotificationService ticketNotificationService, ISettableTenantContext tenantContext) : IDomainEventHandler<TicketProjectUpdated>
{
    public async Task Handle(TicketProjectUpdated notification, CancellationToken cancellationToken)
    {
