...
public class PersonNotFoundException(string personName) : DomainException("Person not found", $"Person {personName} was not found.")
{
    public string PersonName { get; } = personName;
}

public class PersonAlreadyProjectMemberException(string personName, string projectId) : DomainException("Person is already a member", $"Person {personName} is already a member of {projectId}.")
{
    public string PersonName { get; } = personName;
