...
public record class PersonDto(string Id, OrganizationDto Organization, string FirstName, string LastName, string? DisplayName, string Title, string Role, string SSN, string Email, DepartmentDto? Department, Person2Dto? ReportsTo, DateTimeOffset Created, DateTimeOffset? LastModified);
