...
namespace YourBrand.Sales.API.Migrations
{
    ...
    [Migration("20240301113228_UpdateOrderModel2")]
            ...
            modelBuilder.Entity("YourBrand.Sales.API.Features.OrderManagement.Domain.Entities.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BillingDetails", "YourBrand.Sales.API.Features.OrderManagement.Domain.Entities.Order.BillingDetails#BillingDetails", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("Address", "YourBrand.Sales.API.Features.OrderManagement.Domain.Entities.Order.BillingDetails#BillingDetails.Address#Address", b2 =>
                                {
                                    b2.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("ShippingDetails", "YourBrand.Sales.API.Features.OrderManagement.Domain.Entities.Order.ShippingDetails#ShippingDetails", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("Address", "YourBrand.Sales.API.Features.OrderManagement.Domain.Entities.Order.ShippingDetails#ShippingDetails.Address#Address", b2 =>
                                {
                                    b2.IsRequired();
