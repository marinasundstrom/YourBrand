...
{
    public static UserDto ToDto(this Person user) => new UserDto(user.Id, user.FirstName, user.LastName, user.DisplayName, user.Roles?.FirstOrDefault()?.Name ?? "None", user.SSN, user.Email,
