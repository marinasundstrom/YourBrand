...
public class IdentityServicePersonCreatedConsumer : IConsumer<PersonCreated>
{
    ...
    public async Task Consume(ConsumeContext<PersonCreated> context)
    {
        ...
        var result = await _mediator.Send(new CreateUserCommand(message2.PersonId, message2.OrganizationId, message2.FirstName, message2.LastName, message2.DisplayName, "Administrator", message2.SSN, message2.Email, "Abc123!?"));
    }
}
